...
const PURIFIER_MODE = { auto: '자동', silent: '저소음', favorite: '즐겨찾기', idle: '대기', low: '약', medium: '중', high: '강' };
...
function fmtPurifier(method, args) {
  ...
  switch (method) {
    ...
    case 'set_level_favorite': return `즐겨찾기 단계 → ${v}/16`;
...
module.exports = { fmtMiio, fmtMiot, fmtPurifier, onOff };
