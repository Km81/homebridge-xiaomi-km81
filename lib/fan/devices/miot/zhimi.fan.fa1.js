...
class ZhimiFanFa1 extends MiotFan {
  ...
  getVerticalAngle() { return this.getFanProperties().swing_mode_vertical_angle; }
  ...
  getShutdownTimer() { return this.getFanProperties().power_off_time * 60; }
  ...
  async moveUp()                       { return this.sendCommnd('set_move_vertical', 'up'); }
  async moveDown()                     { return this.sendCommnd('set_move_vertical', 'down'); }
