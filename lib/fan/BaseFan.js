...
class BaseFan extends EventEmitter {
  ...
  isFanConnected() { return this.miioFanDevice !== undefined; }

  getFanModel() {
    if (this.isFanConnected()) return this.miioFanDevice.miioModel;
    return this.model;
  }
  ...
  getDeviceId() {
    if (this.isFanConnected()) return this.miioFanDevice.id.replace(/^miio:/, '');
